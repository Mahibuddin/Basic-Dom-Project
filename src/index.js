...
window.onload = function(){
    const taskField = this.document.querySelector('#taskField')
    const addTaskBtn = this.document.querySelector('#addTaskBtn')
    const allTaskParent = this.document.querySelector('#allTAsk')
...
function createColorPallete(parent){
    const colors = ['palegreen', 'powderblue', 'skyblue', 'salmon', 'gray']
